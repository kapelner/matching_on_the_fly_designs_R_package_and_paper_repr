...
res_summ_est = res[, .(ase = round(10000 * mean((estimate - estimand)^2)), num_sim = .N), by = c("n", "response_type", "design", "test_type", "inference_method", "prob_of_adding_response", "betaT")]
