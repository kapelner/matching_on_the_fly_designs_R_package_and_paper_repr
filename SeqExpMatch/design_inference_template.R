...
#'
#' @export
DesignInferenceContMultOLS = R6::R6Class("DesignInferenceContMultOLS",
	...
	public = list(
		...
		#'
		#' seq_des_inf = DesignInferenceContMultOLS$new(seq_des)
		...
		#' seq_des$add_all_subject_responses(c(4.71, 1.23, 4.78, 6.11, 5.95, 8.43))
		#'
		#' seq_des_inf = DesignInferenceContMultOLS$new(seq_des, test_type = "MLE-or-KM-based")
