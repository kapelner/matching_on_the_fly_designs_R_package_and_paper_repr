...
RcppExport SEXP _SeqExpMatch_eigen_compute_single_entry_of_diagonal_matrix_cpp(SEXP MSEXP, SEXP jSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< MapMat >::type M(MSEXP);
    Rcpp::traits::input_parameter< int >::type j(jSEXP);
    rcpp_result_gen = Rcpp::wrap(eigen_compute_single_entry_of_diagonal_matrix_cpp(M, j));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< MapVec >::type w(wSEXP);
...
List fast_logistic_regression_cpp(Rcpp::NumericMatrix X, Rcpp::NumericVector y, Rcpp::NumericVector start, double eps_f, double eps_g, int maxit);
...
static const R_CallMethodDef CallEntries[] = {
    {"_SeqExpMatch_eigen_compute_single_entry_of_diagonal_matrix_cpp", (DL_FUNC) &_SeqExpMatch_eigen_compute_single_entry_of_diagonal_matrix_cpp, 2},
