...
#' infer <- SeqDesignInferenceCountPoissonMultiKKCPoissonCombinedLikelihood$new(seq_des, verbose
#' = FALSE)
#' infer
#'
SeqDesignInferenceCountPoissonMultiKKCPoissonCombinedLikelihood = R6::R6Class("SeqDesignInferenceCountPoissonMultiKKCPoissonCombinedLikelihood",
