...
#' infer <- DesignInferenceCountUnivZeroInflatedPoissonRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountUnivZeroInflatedPoissonRegr = R6::R6Class("DesignInferenceCountUnivZeroInflatedPoissonRegr",
