...
#'
#' @export
SeqDesignInferenceAllKKWilcoxIVWC = R6::R6Class("SeqDesignInferenceAllKKWilcoxIVWC",
	inherit = SeqDesignInferenceAbstractKKWilcoxBaseIVWC,
	public = list(
		...
		#' infer <- SeqDesignInferenceAllKKWilcoxIVWC$new(seq_des, verbose = FALSE)
		#' infer
		#'
