...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiDepCensTransformRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalMultiDepCensTransformRegr = R6::R6Class("DesignInferenceSurvivalMultiDepCensTransformRegr",
	inherit = DesignInferenceSurvivalUniDepCensTransformRegr,
	public = list(
