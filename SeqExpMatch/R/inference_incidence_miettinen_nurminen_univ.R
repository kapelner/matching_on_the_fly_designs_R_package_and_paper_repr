...
#'
#' @export
SeqDesignInferenceIncidUnivMiettinenNurminenRiskDiff = R6::R6Class("SeqDesignInferenceIncidUnivMiettinenNurminenRiskDiff",
	...
	public = list(
		...
		#' }
		#' seq_des_inf = SeqDesignInferenceIncidUnivMiettinenNurminenRiskDiff$new(seq_des)
