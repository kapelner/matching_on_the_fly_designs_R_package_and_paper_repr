...
#' infer <- SeqDesignInferenceCountMultiPoissonRegr$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceCountMultiPoissonRegr = R6::R6Class("SeqDesignInferenceCountMultiPoissonRegr",
	inherit = SeqDesignInferenceCountUnivPoissonRegr,
	public = list(
