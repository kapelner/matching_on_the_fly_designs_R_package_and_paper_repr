...
#' infer <- DesignInferenceCountMultiKKHurdlePoissonIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountMultiKKHurdlePoissonIVWC = R6::R6Class("DesignInferenceCountMultiKKHurdlePoissonIVWC",
