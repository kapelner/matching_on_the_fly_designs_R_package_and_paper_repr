...
#' infer <- SeqDesignInferenceCountPoissonUnivKKCPoissonIVWC$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceCountPoissonUnivKKCPoissonIVWC = R6::R6Class("SeqDesignInferenceCountPoissonUnivKKCPoissonIVWC",
