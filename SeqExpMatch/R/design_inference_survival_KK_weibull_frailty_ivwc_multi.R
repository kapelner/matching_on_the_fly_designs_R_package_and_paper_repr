...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiKKWeibullFrailtyIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalMultiKKWeibullFrailtyIVWC = R6::R6Class("DesignInferenceSurvivalMultiKKWeibullFrailtyIVWC",
	inherit = DesignInferenceAbstractKKWeibullFrailtyIVWC,
	public = list(
