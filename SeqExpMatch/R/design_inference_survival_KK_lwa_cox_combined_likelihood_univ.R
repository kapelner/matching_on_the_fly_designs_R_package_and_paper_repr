...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalUnivKKLWACoxCombinedLikelihood$
#'   new(seq_des, verbose =
#' FALSE)
#' infer
#'
DesignInferenceSurvivalUnivKKLWACoxCombinedLikelihood = R6::R6Class("DesignInferenceSurvivalUnivKKLWACoxCombinedLikelihood",
