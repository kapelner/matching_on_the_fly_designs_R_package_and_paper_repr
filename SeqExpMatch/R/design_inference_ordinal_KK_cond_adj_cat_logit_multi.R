...
#' infer <- DesignInferenceOrdinalMultiKKCondAdjCatLogitRegr$
#'   new(seq_des, verbose = FALSE)
#' infer
#'
DesignInferenceOrdinalMultiKKCondAdjCatLogitRegr = R6::R6Class(
	"DesignInferenceOrdinalMultiKKCondAdjCatLogitRegr",
	inherit = DesignInferenceOrdinalUnivKKCondAdjCatLogitRegr,
	public = list(
		#' @description
