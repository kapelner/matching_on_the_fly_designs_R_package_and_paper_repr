...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- SeqDesignInferenceSurvivalUnivKKWeibullFrailtyIVWC$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceSurvivalUnivKKWeibullFrailtyIVWC = R6::R6Class("SeqDesignInferenceSurvivalUnivKKWeibullFrailtyIVWC",
