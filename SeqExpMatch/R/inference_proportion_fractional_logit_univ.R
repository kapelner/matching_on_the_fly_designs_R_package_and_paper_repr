...
#'
#' @export
SeqDesignInferencePropUniFractionalLogit = R6::R6Class("SeqDesignInferencePropUniFractionalLogit",
	...
	public = list(
		...
		#' }
		#' seq_des_inf = SeqDesignInferencePropUniFractionalLogit$new(seq_des)
