...
#' infer <- SeqDesignInferenceOrdinalUniStereotypeLogitRegr$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceOrdinalUniStereotypeLogitRegr = R6::R6Class("SeqDesignInferenceOrdinalUniStereotypeLogitRegr",
