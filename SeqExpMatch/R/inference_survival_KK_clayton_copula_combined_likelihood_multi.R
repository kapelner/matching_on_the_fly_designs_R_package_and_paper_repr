...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- SeqDesignInferenceSurvivalMultiKKClaytonCopulaCombinedLikelihood$new(seq_des,
#' verbose = FALSE)
#' infer
#'
SeqDesignInferenceSurvivalMultiKKClaytonCopulaCombinedLikelihood = R6::R6Class("SeqDesignInferenceSurvivalMultiKKClaytonCopulaCombinedLikelihood",
