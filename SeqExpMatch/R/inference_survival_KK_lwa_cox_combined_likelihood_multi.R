...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- SeqDesignInferenceSurvivalMultiKKLWACoxCombinedLikelihood$new(seq_des, verbose =
#' FALSE)
#' infer
#'
SeqDesignInferenceSurvivalMultiKKLWACoxCombinedLikelihood = R6::R6Class("SeqDesignInferenceSurvivalMultiKKLWACoxCombinedLikelihood",
