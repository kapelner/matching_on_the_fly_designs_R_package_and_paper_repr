...
#' infer <- SeqDesignInferenceOrdinalMultiCumulProbitRegr$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceOrdinalMultiCumulProbitRegr = R6::R6Class("SeqDesignInferenceOrdinalMultiCumulProbitRegr",
