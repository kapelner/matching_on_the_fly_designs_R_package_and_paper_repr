#' Univariate Conditional Poisson Combined-Likelihood Compound Inference for KK Designs
#'
#' @description
#' Fits a compound estimator for KK matching-on-the-fly designs with count
#' responses using only the treatment indicator (no additional covariates).
...
#' infer <- DesignInferenceCountPoissonUnivKKCPoissonCombinedLikelihood$
#'   new(seq_des, verbose
#' = FALSE)
#' infer
#'
DesignInferenceCountPoissonUnivKKCPoissonCombinedLikelihood = R6::R6Class("DesignInferenceCountPoissonUnivKKCPoissonCombinedLikelihood",
	inherit = DesignInferenceAbstractKKPoissonCPoissonCombinedLikelihood,
	public = list(
