...
#' infer <- SeqDesignInferenceOrdinalMultiKKCondAdjCatLogitRegr$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceOrdinalMultiKKCondAdjCatLogitRegr = R6::R6Class(
	"SeqDesignInferenceOrdinalMultiKKCondAdjCatLogitRegr",
	inherit = SeqDesignInferenceOrdinalUnivKKCondAdjCatLogitRegr,
	public = list(
		#' @description
		#' Initialize a multivariate conditional adjacent-category inference object.
