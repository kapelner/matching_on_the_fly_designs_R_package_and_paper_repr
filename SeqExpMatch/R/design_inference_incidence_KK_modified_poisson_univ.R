...
#' infer <- DesignInferenceIncidUnivKKModifiedPoisson$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceIncidUnivKKModifiedPoisson = R6::R6Class("DesignInferenceIncidUnivKKModifiedPoisson",
	inherit = DesignInferenceAbstractKKModifiedPoisson,
	public = list(
