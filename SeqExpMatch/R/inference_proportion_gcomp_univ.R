...
#'
#' @export
SeqDesignInferencePropUniGCompMeanDiff = R6::R6Class("SeqDesignInferencePropUniGCompMeanDiff",
	inherit = SeqDesignInferencePropGCompAbstract,
	public = list(
		...
		#' }
		#' seq_des_inf = SeqDesignInferencePropUniGCompMeanDiff$new(seq_des)
