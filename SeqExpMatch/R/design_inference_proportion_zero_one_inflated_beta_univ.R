...
#' infer <- DesignInferencePropUniZeroOneInflatedBetaRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferencePropUniZeroOneInflatedBetaRegr = R6::R6Class("DesignInferencePropUniZeroOneInflatedBetaRegr",
