...
#' infer <- InferenceCountPoissonUnivKKCPoissonCombinedLikelihood$
#'   new(seq_des, verbose
#' = FALSE)
#' infer
#'
InferenceCountPoissonUnivKKCPoissonCombinedLikelihood = R6::R6Class("InferenceCountPoissonUnivKKCPoissonCombinedLikelihood",
