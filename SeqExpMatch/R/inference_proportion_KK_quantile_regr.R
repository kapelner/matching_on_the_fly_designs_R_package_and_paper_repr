...
#' \preformatted{
#'   inf = SeqDesignInferencePropMultiKKQuantileRegr$new(seq_des, tau = 0.75)
#' }
...
#'
#' @export
SeqDesignInferencePropMultiKKQuantileRegr = R6::R6Class("SeqDesignInferencePropMultiKKQuantileRegr",
	inherit = SeqDesignInferenceAbstractKKQuantileRegr,
	public = list(

		#' @description
		#' Initialize a sequential experimental design estimation and test object after the sequential design is completed.
		#' @param seq_des_obj		A SeqDesign object whose entire n subjects are assigned and response y is recorded within.
		#' @param tau				The quantile level for regression on the logit scale, strictly between 0 and 1.
