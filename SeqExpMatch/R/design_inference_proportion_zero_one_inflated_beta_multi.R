...
#' infer <- DesignInferencePropMultiZeroOneInflatedBetaRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferencePropMultiZeroOneInflatedBetaRegr = R6::R6Class("DesignInferencePropMultiZeroOneInflatedBetaRegr",
	inherit = DesignInferencePropZeroOneInflatedBetaAbstract,
	public = list(
