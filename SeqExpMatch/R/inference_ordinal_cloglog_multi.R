...
#' infer <- SeqDesignInferenceOrdinalMultiCLLRegr$
#'   new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceOrdinalMultiCLLRegr = R6::R6Class("SeqDesignInferenceOrdinalMultiCLLRegr",
	inherit = SeqDesignInferenceOrdinalUniCLLRegr,
	public = list(
