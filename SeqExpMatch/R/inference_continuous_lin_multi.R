...
#'
#' @export
SeqDesignInferenceContinMultLin = R6::R6Class("SeqDesignInferenceContinMultLin",
	...
	public = list(
		...
		#'
		#' @param seq_des_obj A completed \code{SeqDesign} object with a
		#'   continuous response.
		...
		#' }
		#' seq_des_inf = SeqDesignInferenceContinMultLin$new(seq_des)
