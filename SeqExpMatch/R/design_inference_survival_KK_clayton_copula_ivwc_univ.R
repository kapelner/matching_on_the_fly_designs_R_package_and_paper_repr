...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalUnivKKClaytonCopulaIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalUnivKKClaytonCopulaIVWC = R6::R6Class("DesignInferenceSurvivalUnivKKClaytonCopulaIVWC",
