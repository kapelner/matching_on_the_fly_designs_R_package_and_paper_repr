...
#' infer <- DesignInferenceIncidUnivKKNewcombeRiskDiff$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceIncidUnivKKNewcombeRiskDiff = R6::R6Class("DesignInferenceIncidUnivKKNewcombeRiskDiff",
	inherit = DesignInferenceKKPassThroughCompound,
	public = list(

		#' @description
		#' Initialize the inference object.
		#' @param des_obj A completed KK \code{SeqDesign} object.
