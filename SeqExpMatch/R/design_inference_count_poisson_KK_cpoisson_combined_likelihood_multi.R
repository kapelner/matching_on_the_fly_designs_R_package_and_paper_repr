...
#' infer <- DesignInferenceCountPoissonMultiKKCPoissonCombinedLikelihood$
#'   new(seq_des, verbose
#' = FALSE)
#' infer
#'
DesignInferenceCountPoissonMultiKKCPoissonCombinedLikelihood = R6::R6Class("DesignInferenceCountPoissonMultiKKCPoissonCombinedLikelihood",
