...
#' infer <- DesignInferenceIncidMultiKKClogitCombinedLikelihood$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceIncidMultiKKClogitCombinedLikelihood = R6::R6Class("DesignInferenceIncidMultiKKClogitCombinedLikelihood",
	inherit = DesignInferenceAbstractKKClogitCombinedLikelihood,
	public = list(
