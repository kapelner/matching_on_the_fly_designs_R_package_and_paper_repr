...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiKKLWACoxIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalMultiKKLWACoxIVWC = R6::R6Class("DesignInferenceSurvivalMultiKKLWACoxIVWC",
	inherit = DesignInferenceAbstractKKLWACoxIVWC,
	public = list(
