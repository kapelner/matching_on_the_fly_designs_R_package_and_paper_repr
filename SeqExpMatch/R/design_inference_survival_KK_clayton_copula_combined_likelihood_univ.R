...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalUnivKKClaytonCopulaCombinedLikelihood$
#'   new(seq_des, verbose
#' = FALSE)
#' infer
#'
DesignInferenceSurvivalUnivKKClaytonCopulaCombinedLikelihood = R6::R6Class("DesignInferenceSurvivalUnivKKClaytonCopulaCombinedLikelihood",
