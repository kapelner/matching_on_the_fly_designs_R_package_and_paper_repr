...
#' \preformatted{
#'   inf = SeqDesignInferenceContinMultKKQuantileRegr$new(seq_des, tau = 0.75)
#' }
...
#'
#' @export
SeqDesignInferenceContinMultKKQuantileRegr = R6::R6Class("SeqDesignInferenceContinMultKKQuantileRegr",
