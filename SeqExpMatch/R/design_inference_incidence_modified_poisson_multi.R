...
#' infer <- DesignInferenceIncidMultiModifiedPoisson$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceIncidMultiModifiedPoisson = R6::R6Class("DesignInferenceIncidMultiModifiedPoisson",
	inherit = DesignInferenceIncidUnivModifiedPoisson,
	public = list(
