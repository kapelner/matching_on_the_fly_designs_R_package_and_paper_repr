...
#' infer <- SeqDesignInferenceOrdinalMultiContRatioRegr$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceOrdinalMultiContRatioRegr = R6::R6Class(
	"SeqDesignInferenceOrdinalMultiContRatioRegr",
	inherit = SeqDesignInferenceOrdinalContRatioRegr,
	public = list(
		#' @description
