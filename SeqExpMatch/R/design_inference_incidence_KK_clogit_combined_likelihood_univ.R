...
#' infer <- DesignInferenceIncidUnivKKClogitCombinedLikelihood$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceIncidUnivKKClogitCombinedLikelihood = R6::R6Class("DesignInferenceIncidUnivKKClogitCombinedLikelihood",
