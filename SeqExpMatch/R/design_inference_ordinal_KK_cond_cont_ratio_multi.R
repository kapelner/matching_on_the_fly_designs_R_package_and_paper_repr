...
#' infer <- DesignInferenceOrdinalMultiKKCondContRatioRegr$
#'   new(seq_des, verbose = FALSE)
#' infer
#'
DesignInferenceOrdinalMultiKKCondContRatioRegr = R6::R6Class(
	"DesignInferenceOrdinalMultiKKCondContRatioRegr",
	inherit = DesignInferenceOrdinalUnivKKCondContRatioRegr,
	public = list(
		#' @description
