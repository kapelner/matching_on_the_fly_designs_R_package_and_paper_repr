...
#' infer <- DesignInferencePropMultiBetaRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferencePropMultiBetaRegr = R6::R6Class("DesignInferencePropMultiBetaRegr",
	inherit = DesignInferencePropUniBetaRegr,
	public = list(
