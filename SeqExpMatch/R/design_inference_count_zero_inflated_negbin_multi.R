...
#' infer <- DesignInferenceCountMultiZeroInflatedNegBinRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountMultiZeroInflatedNegBinRegr = R6::R6Class("DesignInferenceCountMultiZeroInflatedNegBinRegr",
	inherit = DesignInferenceCountUnivZeroInflatedNegBinRegr,
	private = list(
