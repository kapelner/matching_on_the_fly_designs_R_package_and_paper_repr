...
#' infer <- DesignInferenceCountMultiHurdlePoissonRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountMultiHurdlePoissonRegr = R6::R6Class("DesignInferenceCountMultiHurdlePoissonRegr",
	inherit = DesignInferenceCountUnivHurdlePoissonRegr,
	private = list(
