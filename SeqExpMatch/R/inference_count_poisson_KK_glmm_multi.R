...
#' @export
InferenceCountPoissonMultiKKGLMM = R6::R6Class("InferenceCountPoissonMultiKKGLMM",
	...
	public = list(
		...
		#' @examples
		#' \dontrun{
		#' seq_des = DesignSeqOneByOneKK14$new(n = 20, response_type = "count")
		#' for (i in 1 : 20){
		#'   seq_des$add_subject_to_experiment_and_assign(data.frame(x = rnorm(1)))
		#' }
		#' seq_des$add_all_subject_responses(rpois(20, 3))
		#'
		#' seq_des_inf = InferenceCountPoissonMultiKKGLMM$new(seq_des)
