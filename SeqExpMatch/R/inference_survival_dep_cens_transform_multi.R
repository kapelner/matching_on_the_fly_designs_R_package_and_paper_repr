...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- SeqDesignInferenceSurvivalMultiDepCensTransformRegr$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceSurvivalMultiDepCensTransformRegr = R6::R6Class("SeqDesignInferenceSurvivalMultiDepCensTransformRegr",
	inherit = SeqDesignInferenceSurvivalUniDepCensTransformRegr,
	public = list(
