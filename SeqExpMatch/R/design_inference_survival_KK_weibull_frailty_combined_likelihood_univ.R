...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalUnivKKWeibullFrailtyCombinedLikelihood$
#'   new(seq_des,
#' verbose = FALSE)
#' infer
#'
DesignInferenceSurvivalUnivKKWeibullFrailtyCombinedLikelihood = R6::R6Class("DesignInferenceSurvivalUnivKKWeibullFrailtyCombinedLikelihood",
