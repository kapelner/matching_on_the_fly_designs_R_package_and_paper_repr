...
#' @export
DesignInferenceContinUnivKKGLMM = R6::R6Class("DesignInferenceContinUnivKKGLMM",
	inherit = DesignInferenceAbstractKKGLMM,
	public = list(

		#' @description
		#' Initialize a univariate linear mixed model inference object for a completed KK design
		...
		#'
		#' seq_des_inf = DesignInferenceContinUnivKKGLMM$new(seq_des)
