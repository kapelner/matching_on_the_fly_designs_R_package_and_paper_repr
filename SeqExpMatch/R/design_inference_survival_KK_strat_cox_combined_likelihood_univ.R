...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalUnivKKStratCoxCombinedLikelihood$
#'   new(seq_des, verbose =
#' FALSE)
#' infer
#'
DesignInferenceSurvivalUnivKKStratCoxCombinedLikelihood = R6::R6Class("DesignInferenceSurvivalUnivKKStratCoxCombinedLikelihood",
