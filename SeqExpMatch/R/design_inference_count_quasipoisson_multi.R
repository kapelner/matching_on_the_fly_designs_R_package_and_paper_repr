...
#' infer <- DesignInferenceCountMultiQuasiPoissonRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountMultiQuasiPoissonRegr = R6::R6Class("DesignInferenceCountMultiQuasiPoissonRegr",
	inherit = DesignInferenceCountUnivQuasiPoissonRegr,
	public = list(
