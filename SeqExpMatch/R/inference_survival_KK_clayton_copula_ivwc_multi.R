...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- SeqDesignInferenceSurvivalMultiKKClaytonCopulaIVWC$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceSurvivalMultiKKClaytonCopulaIVWC = R6::R6Class("SeqDesignInferenceSurvivalMultiKKClaytonCopulaIVWC",
	inherit = SeqDesignInferenceAbstractKKClaytonCopulaIVWC,
	public = list(
