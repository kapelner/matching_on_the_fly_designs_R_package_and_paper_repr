...
#'
#' @export
SeqDesignInferenceIncidUnivModifiedPoisson = R6::R6Class("SeqDesignInferenceIncidUnivModifiedPoisson",
	...
	public = list(
		...
		#' @param seq_des_obj A completed \code{SeqDesign} object with an
		#'   incidence response.
		...
		#' }
		#' seq_des_inf = SeqDesignInferenceIncidUnivModifiedPoisson$new(seq_des)
