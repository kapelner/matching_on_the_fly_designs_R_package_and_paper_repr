...
#
# @keywords internal
DesignInferenceAbstractKKClogitIVWC = R6::R6Class("DesignInferenceAbstractKKClogitIVWC",
	...
	private = list(
		...
		shared = function(){
			...
			# --- Variance-weighted combination (mirrors DesignInferenceContinMultOLSKK) ---
			if (m_ok && r_ok){
