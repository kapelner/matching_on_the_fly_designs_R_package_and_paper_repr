...
#' infer <- DesignInferenceOrdinalMultiKKGEE$
#'   new(seq_des, verbose = FALSE)
#' infer
#' }
#'
DesignInferenceOrdinalMultiKKGEE = R6::R6Class("DesignInferenceOrdinalMultiKKGEE",
	inherit = DesignInferenceOrdinalUnivKKGEE,
	public = list(
		#' @description
