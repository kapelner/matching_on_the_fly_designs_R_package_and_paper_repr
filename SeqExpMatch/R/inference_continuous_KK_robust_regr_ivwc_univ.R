...
#'
#' @export
SeqDesignInferenceContinUnivKKRobustRegrIVWC = R6::R6Class("SeqDesignInferenceContinUnivKKRobustRegrIVWC",
	...
	public = list(
		...
		#' infer <- SeqDesignInferenceContinUnivKKRobustRegrIVWC$new(seq_des, verbose = FALSE)
		#' infer
		#'
