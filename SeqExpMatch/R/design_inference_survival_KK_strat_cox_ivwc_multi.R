...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiKKStratCoxIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalMultiKKStratCoxIVWC = R6::R6Class("DesignInferenceSurvivalMultiKKStratCoxIVWC",
	inherit = DesignInferenceAbstractKKStratCoxIVWC,
	public = list(
