...
#'
#' @description
#' Extends \code{DesignInferenceIncidExactZhang} with the KK matched-pair exact test,
...
#' infer <- DesignInferenceIncidKKExactZhang$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceIncidKKExactZhang = R6::R6Class("DesignInferenceIncidKKExactZhang",
	inherit = DesignInferenceIncidExactZhang,
	public = list(
