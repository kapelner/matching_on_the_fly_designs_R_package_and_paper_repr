...
#'
#' @details
#' This class requires the \pkg{ordinal} package, which is listed under \code{Suggests}
#' and is not installed automatically with \pkg{SeqExpMatch}. Install it manually with
#' \code{install.packages("ordinal")} before using this class.
#'
#' @export
#' @examples
#' set.seed(1)
...
#' infer <- SeqDesignInferenceOrdinalUnivKKGLMM$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceOrdinalUnivKKGLMM = R6::R6Class("SeqDesignInferenceOrdinalUnivKKGLMM",
