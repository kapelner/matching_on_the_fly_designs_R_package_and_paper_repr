...
#' infer <- DesignInferenceCountMultiZeroInflatedPoissonRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountMultiZeroInflatedPoissonRegr = R6::R6Class("DesignInferenceCountMultiZeroInflatedPoissonRegr",
	inherit = DesignInferenceCountUnivZeroInflatedPoissonRegr,
	private = list(
