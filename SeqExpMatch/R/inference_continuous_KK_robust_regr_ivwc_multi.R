...
#'
#' @export
SeqDesignInferenceContinMultiKKRobustRegrIVWC = R6::R6Class("SeqDesignInferenceContinMultiKKRobustRegrIVWC",
	inherit = SeqDesignInferenceAbstractKKRobustRegrIVWC,
	public = list(
		...
		#' infer <- SeqDesignInferenceContinMultiKKRobustRegrIVWC$new(seq_des, verbose = FALSE)
		#' infer
		#'
