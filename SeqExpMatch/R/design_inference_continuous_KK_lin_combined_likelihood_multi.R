...
#'
#' @export
DesignInferenceContinMultiKKLinCombinedLikelihood = R6::R6Class("DesignInferenceContinMultiKKLinCombinedLikelihood",
	...
	public = list(
		...
		#' infer <- DesignInferenceContinMultiKKLinCombinedLikelihood$new(seq_des, verbose = FALSE)
		#' infer
		#'
