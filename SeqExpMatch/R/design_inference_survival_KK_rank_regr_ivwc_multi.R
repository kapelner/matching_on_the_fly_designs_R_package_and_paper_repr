...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiKKRankRegrIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalMultiKKRankRegrIVWC = R6::R6Class("DesignInferenceSurvivalMultiKKRankRegrIVWC",
	inherit = DesignInferenceAbstractKKSurvivalRankRegrIVWC,
	public = list(
