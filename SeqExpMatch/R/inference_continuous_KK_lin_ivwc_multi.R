...
#'
#' @export
SeqDesignInferenceContinMultiKKLinIVWC = R6::R6Class("SeqDesignInferenceContinMultiKKLinIVWC",
	...
	public = list(
		...
		#' }
		#' seq_des_inf = SeqDesignInferenceContinMultiKKLinIVWC$new(seq_des)
