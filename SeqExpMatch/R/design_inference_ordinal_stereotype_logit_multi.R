...
#' infer <- DesignInferenceOrdinalMultiStereotypeLogitRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceOrdinalMultiStereotypeLogitRegr = R6::R6Class("DesignInferenceOrdinalMultiStereotypeLogitRegr",
	inherit = DesignInferenceOrdinalUniStereotypeLogitRegr,
	public = list(
