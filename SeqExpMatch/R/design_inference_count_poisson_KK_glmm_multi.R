...
#'
#' @export
DesignInferenceCountPoissonMultiKKGLMM = R6::R6Class("DesignInferenceCountPoissonMultiKKGLMM",
	...
	public = list(
		...
		#'
		#' seq_des_inf = DesignInferenceCountPoissonMultiKKGLMM$new(seq_des)
