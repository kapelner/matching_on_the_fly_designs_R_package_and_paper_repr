...
#' infer <- DesignInferenceIncidMultiKKModifiedPoisson$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceIncidMultiKKModifiedPoisson = R6::R6Class("DesignInferenceIncidMultiKKModifiedPoisson",
	inherit = DesignInferenceIncidUnivKKModifiedPoisson,
	public = list(
