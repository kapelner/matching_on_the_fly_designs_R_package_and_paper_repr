...
#' standard Weibull AFT singleton likelihood terms. The treatment effect is reported as a
#' log-time ratio.
#'
...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiKKClaytonCopulaCombinedLikelihood$
#'   new(seq_des,
#' verbose = FALSE)
#' infer
#'
DesignInferenceSurvivalMultiKKClaytonCopulaCombinedLikelihood = R6::R6Class("DesignInferenceSurvivalMultiKKClaytonCopulaCombinedLikelihood",
	inherit = DesignInferenceAbstractKKClaytonCopulaCombinedLikelihood,
	public = list(
