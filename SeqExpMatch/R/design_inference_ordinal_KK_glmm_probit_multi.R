...
#' infer <- DesignInferenceOrdinalMultiKKGLMMProbit$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceOrdinalMultiKKGLMMProbit = R6::R6Class("DesignInferenceOrdinalMultiKKGLMMProbit",
	inherit = DesignInferenceAbstractKKOrdinalCLMM,
	public = list(
		#' @description
		#' Initialize a multivariate ordinal probit CLMM inference object for a
		#' completed KK design.
		#' @param	des_obj		A SeqDesign object (must be a KK design) whose entire
