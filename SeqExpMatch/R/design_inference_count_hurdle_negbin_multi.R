...
#' infer <- DesignInferenceCountMultiHurdleNegBinRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountMultiHurdleNegBinRegr = R6::R6Class("DesignInferenceCountMultiHurdleNegBinRegr",
	inherit = DesignInferenceCountUnivHurdleNegBinRegr,
	private = list(
