...
#'
#' @export
DesignInferenceIncidUnivModifiedPoisson = R6::R6Class("DesignInferenceIncidUnivModifiedPoisson",
	...
	public = list(
		...
		#' }
		#' seq_des_inf = DesignInferenceIncidUnivModifiedPoisson$new(seq_des)
