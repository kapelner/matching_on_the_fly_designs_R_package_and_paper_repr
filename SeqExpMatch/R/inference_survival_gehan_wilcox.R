...
#' \code{SeqDesignInferenceSurvivalKMDiff}.
#'
#' @export
SeqDesignInferenceSurvivalGehanWilcox = R6::R6Class("SeqDesignInferenceSurvivalGehanWilcox",
	...
	public = list(
		...
		compute_mle_two_sided_pval_for_treatment_effect = function(delta = 0){
			...
			if (delta == 0){
				...
				stop("Testing non-zero delta is not yet implemented for SeqDesignInferenceSurvivalGehanWilcox.")
			}
		},
