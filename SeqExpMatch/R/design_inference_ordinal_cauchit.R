...
#' infer <- DesignInferenceOrdinalUniCauchitRegr$
#'   new(seq_des, verbose = FALSE)
#' infer
#'
DesignInferenceOrdinalUniCauchitRegr = R6::R6Class("DesignInferenceOrdinalUniCauchitRegr",
...
#' }
#' seq_des$add_all_subject_responses(as.integer(c(1, 2, 2, 3, 3, 4, 4, 5)))
#' infer <- DesignInferenceOrdinalMultiCauchitRegr$
#'   new(seq_des, verbose = FALSE)
#' infer
#'
DesignInferenceOrdinalMultiCauchitRegr = R6::R6Class("DesignInferenceOrdinalMultiCauchitRegr",
	inherit = DesignInferenceOrdinalUniCauchitRegr,
	public = list(
		#' @description
		#' Initialize a sequential experimental design estimation and test object.
		#' @param des_obj A SeqDesign object whose entire n subjects are assigned and
