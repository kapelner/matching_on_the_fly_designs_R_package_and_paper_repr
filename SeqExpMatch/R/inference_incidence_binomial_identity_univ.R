...
#'
#' @export
SeqDesignInferenceIncidUnivBinomialIdentityRiskDiff = R6::R6Class("SeqDesignInferenceIncidUnivBinomialIdentityRiskDiff",
	inherit = SeqDesignInferenceIncidBinomialIdentityAbstract,
	private = list(
