...
#' cluster-robust variance. For reservoir subjects, it uses standard Cox regression.
...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- SeqDesignInferenceSurvivalMultiKKLWACoxIVWC$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceSurvivalMultiKKLWACoxIVWC = R6::R6Class("SeqDesignInferenceSurvivalMultiKKLWACoxIVWC",
	inherit = SeqDesignInferenceAbstractKKLWACoxIVWC,
	public = list(
