...
#' infer <- SeqDesignInferenceCountUnivPoissonRegr$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceCountUnivPoissonRegr = R6::R6Class("SeqDesignInferenceCountUnivPoissonRegr",
