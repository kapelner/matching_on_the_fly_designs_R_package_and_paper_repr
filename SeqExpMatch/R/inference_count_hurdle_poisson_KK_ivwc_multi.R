...
#' infer <- SeqDesignInferenceCountMultiKKHurdlePoissonIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
SeqDesignInferenceCountMultiKKHurdlePoissonIVWC = R6::R6Class("SeqDesignInferenceCountMultiKKHurdlePoissonIVWC",
