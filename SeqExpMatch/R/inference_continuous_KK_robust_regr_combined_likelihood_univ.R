...
#'
#' @export
SeqDesignInferenceContinUnivKKRobustRegrCombinedLikelihood = R6::R6Class("SeqDesignInferenceContinUnivKKRobustRegrCombinedLikelihood",
	...
	public = list(
		...
		#' infer <- SeqDesignInferenceContinUnivKKRobustRegrCombinedLikelihood$new(seq_des, verbose =
		#' FALSE)
		#' infer
		#'
