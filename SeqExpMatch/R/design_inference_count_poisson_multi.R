...
#' infer <- DesignInferenceCountMultiPoissonRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountMultiPoissonRegr = R6::R6Class("DesignInferenceCountMultiPoissonRegr",
	inherit = DesignInferenceCountUnivPoissonRegr,
	public = list(
