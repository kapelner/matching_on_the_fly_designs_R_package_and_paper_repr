#' Multivariate Rank-based Regression (R-Estimation) Compound Inference for KK Designs
#'
#' @description
...
#' including both treatment and covariates.
#'
#' @export
SeqDesignInferenceAllKKRankRegrMulti = R6::R6Class("SeqDesignInferenceAllKKRankRegrMulti",
