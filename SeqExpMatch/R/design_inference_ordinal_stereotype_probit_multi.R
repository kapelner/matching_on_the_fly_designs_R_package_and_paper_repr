...
#' infer <- DesignInferenceOrdinalMultiStereotypeProbitRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceOrdinalMultiStereotypeProbitRegr = R6::R6Class("DesignInferenceOrdinalMultiStereotypeProbitRegr",
	inherit = DesignInferenceOrdinalUniStereotypeProbitRegr,
	public = list(
