...
#
# @keywords internal
DesignInferenceAbstractZhangCombinedBase = R6::R6Class("DesignInferenceAbstractZhangCombinedBase",
	...
	public = list(
		...
		initialize = function(seq_des_obj, num_cores = 1, verbose = FALSE){
			...
			# For KK designs set up match data eagerly (mirrors DesignInferenceKKPassThrough)
	...
	private = list(
		...
		# -----------------------------------------------------------------------
		# KK match-data setup (mirrors DesignInferenceKKPassThrough)
		# -----------------------------------------------------------------------
