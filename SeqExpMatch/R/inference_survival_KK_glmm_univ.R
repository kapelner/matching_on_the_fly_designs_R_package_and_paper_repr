...
#' @export
InferenceSurvivalUnivKKGLMM = R6::R6Class("InferenceSurvivalUnivKKGLMM",
	...
	public = list(
		...
		#' @examples
		#' \dontrun{
		#' seq_des = DesignSeqOneByOneKK14$new(n = 20, response_type = "survival")
		#' for (i in 1 : 20){
		...
		#'
		#' seq_des_inf = InferenceSurvivalUnivKKGLMM$new(seq_des)
