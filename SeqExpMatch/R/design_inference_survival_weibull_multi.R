...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiWeibullRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalMultiWeibullRegr = R6::R6Class("DesignInferenceSurvivalMultiWeibullRegr",
	inherit = DesignInferenceSurvivalUniWeibullRegr,
	public = list(
	...
	private = list(
		generate_mod = function(){
			# Multivariate: covariates + treatment (mirrors DesignInferenceSurvivalMultiCoxPHRegr)
