...
#' infer <- DesignInferencePropMultiKKQuantileRegrCombinedLikelihood$
#'   new(seq_des, verbose =
#' FALSE)
#' infer
#'
DesignInferencePropMultiKKQuantileRegrCombinedLikelihood = R6::R6Class("DesignInferencePropMultiKKQuantileRegrCombinedLikelihood",
