...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalUniWeibullRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalUniWeibullRegr = R6::R6Class("DesignInferenceSurvivalUniWeibullRegr",
	inherit = DesignInferenceMLEorKMSummaryTable,
	public = list(
	...
	private = list(
		generate_mod = function(){
			# Univariate: treatment only, no covariates (mirrors DesignInferenceSurvivalUniCoxPHRegr)
