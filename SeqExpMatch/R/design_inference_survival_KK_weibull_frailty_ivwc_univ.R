...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalUnivKKWeibullFrailtyIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalUnivKKWeibullFrailtyIVWC = R6::R6Class("DesignInferenceSurvivalUnivKKWeibullFrailtyIVWC",
