...
#'
#' @export
SeqDesignInferenceCountUnivKKCPoissonCombinedLikelihood = R6::R6Class("SeqDesignInferenceCountUnivKKCPoissonCombinedLikelihood",
	inherit = SeqDesignInferenceAbstractKKCPoissonCombinedLikelihood,
	public = list(
