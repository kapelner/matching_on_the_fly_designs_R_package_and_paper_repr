...
#'
#' @export
SeqDesignInferenceContinUnivRobustRegr = R6::R6Class("SeqDesignInferenceContinUnivRobustRegr",
	...
	public = list(
		...
		#'
		#' seq_des_inf = SeqDesignInferenceContinUnivRobustRegr$new(seq_des)
