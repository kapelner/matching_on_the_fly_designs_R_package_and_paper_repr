...
#' infer <- DesignInferenceCountMultiNegBinRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountMultiNegBinRegr = R6::R6Class("DesignInferenceCountMultiNegBinRegr",
	inherit = DesignInferenceCountUnivNegBinRegr,
	public = list(
