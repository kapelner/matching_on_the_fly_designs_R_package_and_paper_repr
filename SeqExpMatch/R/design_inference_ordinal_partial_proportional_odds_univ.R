...
#' infer <- DesignInferenceOrdinalUniPartialProportionalOddsRegr$
#'   new(seq_des, verbose = FALSE)
#' infer
DesignInferenceOrdinalUniPartialProportionalOddsRegr = R6::R6Class(
	"DesignInferenceOrdinalUniPartialProportionalOddsRegr",
