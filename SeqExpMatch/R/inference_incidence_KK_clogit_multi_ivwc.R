...
#'
#' @export
SeqDesignInferenceIncidMultiKKClogitIVWC = R6::R6Class("SeqDesignInferenceIncidMultiKKClogitIVWC",
	inherit = SeqDesignInferenceAbstractKKClogitIVWC,
	public = list(

		#' @description
		#' Initialize a multivariate conditional logistic regression inference object for a
		...
		#'
		#' seq_des_inf = SeqDesignInferenceIncidMultiKKClogitIVWC$new(seq_des)
