...
#' infer <- SeqDesignInferenceCountPoissonMultiKKCPoissonIVWC$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceCountPoissonMultiKKCPoissonIVWC = R6::R6Class("SeqDesignInferenceCountPoissonMultiKKCPoissonIVWC",
	inherit = SeqDesignInferenceAbstractKKPoissonCPoissonIVWC,
	public = list(
