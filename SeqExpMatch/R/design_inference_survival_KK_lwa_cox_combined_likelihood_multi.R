...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiKKLWACoxCombinedLikelihood$
#'   new(seq_des, verbose =
#' FALSE)
#' infer
#'
DesignInferenceSurvivalMultiKKLWACoxCombinedLikelihood = R6::R6Class("DesignInferenceSurvivalMultiKKLWACoxCombinedLikelihood",
