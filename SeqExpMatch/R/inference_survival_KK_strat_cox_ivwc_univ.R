...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- SeqDesignInferenceSurvivalUnivKKStratCoxIVWC$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceSurvivalUnivKKStratCoxIVWC = R6::R6Class("SeqDesignInferenceSurvivalUnivKKStratCoxIVWC",
