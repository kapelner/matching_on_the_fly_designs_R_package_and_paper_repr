...
#'
#' @export
SeqDesignInferenceCountPoissonUnivKKGLMM = R6::R6Class("SeqDesignInferenceCountPoissonUnivKKGLMM",
	...
	public = list(
		...
		#'
		#' seq_des_inf = SeqDesignInferenceCountPoissonUnivKKGLMM$new(seq_des)
