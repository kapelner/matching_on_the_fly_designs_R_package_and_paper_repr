...
#' infer <- SeqDesignInferenceOrdinalMultiKKGEE$new(seq_des, verbose = FALSE)
#' infer
#' }
#'
SeqDesignInferenceOrdinalMultiKKGEE = R6::R6Class("SeqDesignInferenceOrdinalMultiKKGEE",
	inherit = SeqDesignInferenceOrdinalUnivKKGEE,
	public = list(
		#' @description
