...
#
# @keywords internal
DesignInferenceRandCI = R6::R6Class("DesignInferenceRandCI",
	inherit = DesignInferenceRand,
	public = list(
		# @description
		...
		compute_confidence_interval_rand = function(alpha = 0.05, r = 501, pval_epsilon = 0.005, show_progress = TRUE){
			...
			if (resp_type == "incidence") stop("Randomization CI not supported for incidence. Use Zhang method.")
