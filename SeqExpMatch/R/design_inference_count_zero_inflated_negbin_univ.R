...
#' infer <- DesignInferenceCountUnivZeroInflatedNegBinRegr$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountUnivZeroInflatedNegBinRegr = R6::R6Class("DesignInferenceCountUnivZeroInflatedNegBinRegr",
