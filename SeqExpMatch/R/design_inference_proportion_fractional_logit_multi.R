...
#' infer <- DesignInferencePropMultiFractionalLogit$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferencePropMultiFractionalLogit = R6::R6Class("DesignInferencePropMultiFractionalLogit",
	inherit = DesignInferencePropUniFractionalLogit,
	public = list(
