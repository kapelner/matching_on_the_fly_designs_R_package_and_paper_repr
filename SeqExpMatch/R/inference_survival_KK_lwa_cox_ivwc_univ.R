...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- SeqDesignInferenceSurvivalUnivKKLWACoxIVWC$new(seq_des, verbose = FALSE)
#' infer
#'
SeqDesignInferenceSurvivalUnivKKLWACoxIVWC = R6::R6Class("SeqDesignInferenceSurvivalUnivKKLWACoxIVWC",
