...
#' infer <- DesignInferenceCountPoissonMultiKKCPoissonIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceCountPoissonMultiKKCPoissonIVWC = R6::R6Class("DesignInferenceCountPoissonMultiKKCPoissonIVWC",
