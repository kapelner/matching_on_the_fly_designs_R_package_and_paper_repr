...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiKKStratCoxCombinedLikelihood$
#'   new(seq_des, verbose =
#' FALSE)
#' infer
#'
DesignInferenceSurvivalMultiKKStratCoxCombinedLikelihood = R6::R6Class("DesignInferenceSurvivalMultiKKStratCoxCombinedLikelihood",
	inherit = DesignInferenceAbstractKKStratCoxCombinedLikelihood,
	public = list(
