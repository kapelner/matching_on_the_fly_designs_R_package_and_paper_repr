...
#'   c(1, 1, 0, 1, 0, 1, 1, 0)
#' )
#' infer <- DesignInferenceSurvivalMultiKKClaytonCopulaIVWC$
#'   new(
#'   seq_des,
#'   verbose = FALSE
#' )
#' infer
#'
DesignInferenceSurvivalMultiKKClaytonCopulaIVWC = R6::R6Class("DesignInferenceSurvivalMultiKKClaytonCopulaIVWC",
	inherit = DesignInferenceAbstractKKClaytonCopulaIVWC,
	public = list(
