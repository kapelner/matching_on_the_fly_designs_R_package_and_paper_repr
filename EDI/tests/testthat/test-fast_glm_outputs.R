...
test_that("fast_logistic_regression_with_var_cpp matches glm", {
	...
	# fast version
	fast_mod <- EDI:::fast_logistic_regression_with_var_cpp(X, y)
...
test_that("fast_weibull_regression matches survreg", {
	...
	fast_mod <- EDI:::fast_weibull_regression(y, dead, X)
...
test_that("fast_beta_regression_mle matches betareg", {
	...
	# fast version
	fast_mod <- EDI:::fast_beta_regression_with_var_cpp(X_int, y, compute_std_errs = TRUE)
...
test_that("fast_neg_bin_with_var_cpp matches MASS::glm.nb", {
	...
	fast_mod <- EDI:::fast_neg_bin_with_var_cpp(X_int, y)
