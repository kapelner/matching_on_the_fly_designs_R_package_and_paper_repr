...
#'
#' @details
#' The class name uses `OneLik` to match the package terminology used
...
#'
#' @export
InferenceContinMultiKKLinOneLik = R6::R6Class("InferenceContinMultiKKLinOneLik",
	lock_objects = FALSE,
	...
	public = list(
		...
		#' infer <- InferenceContinMultiKKLinOneLik$new(seq_des, verbose = FALSE)
		#' infer
		#'
